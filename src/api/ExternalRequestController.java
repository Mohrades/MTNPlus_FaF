...
public class ExternalRequestController {
    ...
    @RequestMapping(value="/faf/add/{msisdn}", params={"authentication=true", "originOperatorID"}, method=RequestMethod.POST, produces = "text/xml;charset=UTF-8")
    ...
    @RequestMapping(value="/faf/delete/{msisdn}", params={"authentication=true", "originOperatorID"}, method=RequestMethod.POST, produces = "text/xml;charset=UTF-8")
    ...
    @RequestMapping(value="/faf/modify/{msisdn}", params={"authentication=true", "originOperatorID"}, method=RequestMethod.POST, produces = "text/xml;charset=UTF-8")
	...
	public ModelAndView handleFaFStatusRequest(HttpServletRequest request, @RequestParam("msisdn") String msisdn, @PathVariable("msisdn") String msisdn_confirmation) throws Exception {
		AccountDetails accountDetails = new AIRRequest().getAccountDetails(msisdn);
		int language = (accountDetails == null) ? 1 : accountDetails.getLanguageIDCurrent();
    	return callback(msisdn, -1, i18n.getMessage("service.internal.error", null, null, (language == 2) ? Locale.ENGLISH : Locale.FRENCH));
    }
